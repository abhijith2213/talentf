     ...
     {userName !== userData.userName ? 
      ...
      <div className="flex justify-end pr-4">
        {userName !== userData.userName ? <>{!user?.followers?.includes(userId)?
         ...
         :<>
         <button onClick={(e)=>handleMessage(user._id)} type="button" className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
           message
        </button>
